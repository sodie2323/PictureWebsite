...
import com.yupi.yupicturebackend.mq.MqConstant;
...
//        checkPictureAuth(loginUser, picture);
    ...
    @Override
    public void createPictureOutPaintingTaskAsync(CreatePictureOutPaintingTaskRequest createPictureOutPaintingTaskRequest, User loginUser) {
        // 获取图片信息
        Long pictureId = createPictureOutPaintingTaskRequest.getPictureId();
        Picture picture = Optional.ofNullable(this.getById(pictureId))
                .orElseThrow(() -> new BusinessException(ErrorCode.NOT_FOUND_ERROR, "图片不存在"));
...
//        checkPictureAuth(loginUser, picture);
        ...
        createOutPaintingTaskRequest.setParameters(createPictureOutPaintingTaskRequest.getParameters());
        // 创建任务
        rabbitTemplate.convertAndSend(MqConstant.BI_EXCHANGE_NAME, MqConstant.BI_ROUTING_KEY, createOutPaintingTaskRequest);
    }
